...
<head>
	<title>
		<?= htmlspecialchars($profiles[$profile]['name']) ?>'s Resume
	</title>
			...
			<header class="resume-header pt-4 pt-md-0">
				<div class="row">
					<div class="col-block col-md-auto resume-picture-holder text-center text-md-start">
						<img class="picture"
							src="assets/images/profilephotos/<?= htmlspecialchars($profiles[$profile]['photoPath']); ?>"
							alt="">
					</div><!--//col-->
					<div class="col">
						<div class="row p-4 justify-content-center justify-content-md-between">
							<div class="primary-info col-auto">
								<h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">
									<?= htmlspecialchars($profiles[$profile]['name']); ?>
								</h1>
								<div class="title mb-3">
									<?= htmlspecialchars($profiles[$profile]['jobTitle']) ?>
								</div>
								<ul class="list-unstyled">
									<?php if ($profiles[$profile]['emailAddress'] !== null): ?>
										<li class="mb-2"><a class="text-link"
												href="mailto:<?= htmlspecialchars($profiles[$profile]['emailAddress']); ?>"><i
													class="far fa-envelope fa-fw me-2" data-fa-transform="grow-3"></i>
												<?= htmlspecialchars($profiles[$profile]['emailAddress']) ?>
											</a></li>
									<?php endif ?>
									<?php if ($profiles[$profile]['phoneNumber'] !== null): ?>
										<li><a class="text-link"
												href="tel:<?= preg_replace("/[^0-9]/", '', $profiles[$profile]['phoneNumber']); ?>"><i
													class="fas fa-mobile-alt fa-fw me-2" data-fa-transform="grow-6"></i>
												<?= htmlspecialchars($profiles[$profile]['phoneNumber']) ?>
											</a></li>
									<?php endif ?>
								</ul>
							</div><!--//primary-info-->
								...
								<ul class="resume-social list-unstyled">
									<?php if ($profiles[$profile]['unameLinkedIn'] !== null): ?>
										<li class="mb-3"><a class="text-link"
												href="https://<?= htmlspecialchars($profiles[$profile]['unameLinkedIn']); ?>"><span
													class="fa-container text-center me-2"><i
														class="fab fa-linkedin-in fa-fw"></i></span>
												<?= htmlspecialchars($profiles[$profile]['unameLinkedIn']) ?>
											</a></li>
									<?php endif ?>
									<?php if ($profiles[$profile]['unameGitHub'] !== null): ?>
										<li class="mb-3"><a class="text-link"
												href="https://<?= htmlspecialchars($profiles[$profile]['unameGitHub']); ?>"><span
													class="fa-container text-center me-2"><i
														class="fab fa-github-alt fa-fw"></i></span>
												<?= htmlspecialchars($profiles[$profile]['unameGitHub']) ?>
											</a></li>
									<?php endif ?>
									<?php if ($profiles[$profile]['personalWebsite'] !== null): ?>
										<li><a class="text-link"
												href="https://<?= htmlspecialchars($profiles[$profile]['personalWebsite']); ?>"><span
													class="fa-container text-center me-2"><i
														class="fas fa-globe"></i></span>
												<?= htmlspecialchars($profiles[$profile]['personalWebsite']) ?>
											</a></li>
									<?php endif ?>
								</ul>
							</div><!--//secondary-info-->
			...
			<div class="resume-body p-5">
				<section class="resume-section summary-section mb-5">
					...
					<div class="resume-section-content">
						<p class="mb-0">
							<?= htmlspecialchars($profiles[$profile]['personalSummary']) ?>
						</p>
					</div>
